...
class ComplianceMonitor:
    ...
    def _generate_recommendations(self, violations: List[Dict[str, Any]]) -> List[str]:
        ...
        if len(violations) > 5:
            recommendations.append(
                "📚 Review workflow documentation with your team: .gadugi/.gadugi/src/workflow-enforcement/workflow-reminder.md"
            )
        ...
        recommendations.append(
            "🚀 Use orchestrator for all code changes: python .gadugi/.gadugi/src/orchestrator/main.py"
        )
