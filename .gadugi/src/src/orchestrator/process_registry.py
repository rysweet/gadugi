...
class ProcessRegistry:
    ...
    def save_to_file(self, output_file: str) -> None:
        ...
        registry_data = {
            "timestamp": datetime.now().isoformat(),
            "processes": {task_id: asdict(p) for task_id, p in self.processes.items()},
        }
    ...
    def _save_registry(self) -> None:
        ...
        try:
            registry_data = {"timestamp": datetime.now().isoformat(), "processes": {}}
...
def main():
    ...
    parser.add_argument(
        "command",
        choices=["status", "cleanup", "export", "cancel"],
