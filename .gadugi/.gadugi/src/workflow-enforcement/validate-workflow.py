...
class WorkflowValidator:
        ...
        if requires_orchestrator and execution_method != "orchestrator":
            ...
            recommendations.extend(
                [
                    ...
                    f'   python .gadugi/.gadugi/src/orchestrator/main.py --task "{task_description}"',
                    "",
                    "📚 Review workflow requirements:",
                    "   cat .gadugi/.gadugi/src/workflow-enforcement/workflow-reminder.md",
                ]
            )
    ...
    def show_workflow_guide(self):
        ...
        print_colored(Colors.CYAN, "  python .gadugi/.gadugi/src/orchestrator/main.py \\")
        ...
        validation_commands = [
            ...
            '.gadugi/.gadugi/src/workflow-enforcement/validate-workflow.py --task "your task"',
            "",
