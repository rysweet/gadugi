...
async def simulate_agent_lifecycle():
    ...
    print("✉️  Event: orchestration.started")
    ...
    print("✉️  Event: orchestration.problem_identified")
    ...
    print("✉️  Event: decomposition.completed")
    ...
    print("✉️  Event: orchestration.tasks_distributed")
    ...
    print("✉️  Event: workflow.pr_created")
    ...
    print("✉️  Event: workflow.needsApproval")
    ...
    print("✉️  Event: workflow.tests_failed")
    ...
    print("✉️  Event: orchestration.stopped")
    ...
    print("✉️  Event: teamcoach.lessons_learned")
