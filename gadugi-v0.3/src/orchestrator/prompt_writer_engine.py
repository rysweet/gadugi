...
class PromptWriterEngine:
    ...
    def generate_prompt(self, task_description: str, context: Optional[Dict] = None) -> Dict:
        """
    ...
    def _extract_title(self, task_description: str) -> str:
        ...
        title = re.sub(r'^(implement|add|create|build|fix|enhance|update)\s+', '', title, flags=re.IGNORECASE)
    ...
    def _determine_task_type(self, task_description: str) -> str:
        ...
        if any(word in description_lower for word in ['implement', 'add', 'create', 'build']):
            ...
            return "bug_fix"
        elif any(word in description_lower for word in ['enhance', 'improve', 'optimize', 'update']):
            return "enhancement"
        elif any(word in description_lower for word in ['unit test', 'testing', 'test coverage', 'add tests']):
            return "testing"
    ...
    def _estimate_complexity(self, task_description: str) -> str:
        ...
        complexity_indicators = {
            "high": ['system', 'architecture', 'database', 'authentication', 'security', 'integration', 'api'],
    ...
    def _generate_implementation_plan(self, analysis: Dict) -> Dict:
        ...
        if complexity == "high":
            ...
            return {
                "phase1": [
                    "Review existing code and identify changes needed"
                ],
                "phase2": [
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("Example: python prompt_writer_engine.py 'Add user authentication to web app'")
        sys.exit(1)
