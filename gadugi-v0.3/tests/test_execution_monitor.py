...
class TestExecutionMonitorEngine(unittest.TestCase):
    ...
    def test_collect_process_metrics(self, mock_psutil_process):
        ...
        mock_process_instance.memory_info.return_value = MagicMock(rss=134217728)  # 128MB
    ...
    def test_configure_monitoring(self):
        ...
        self.assertEqual(self.engine.configuration.notification_channels, ["email", "webhook"])
    ...
    def test_process_request_alert(self):
        ...
        request = {
            "operation": "alert",
            "parameters": {
                "alert_types": ["resource", "performance"]
            }
        }
    ...
    def test_thread_safety(self):
        ...
        for i in range(5):
            thread = threading.Thread(
                target=lambda i=i: results.append(add_process(i))
            )
