...
from code_writer_engine import (
    CodeWriterEngine,
...
class TestCodeWriterEngine(unittest.TestCase):
    ...
    def test_filename_suggestion(self):
        ...
        for task, language, expected_pattern in test_cases:
            ...
            self.assertTrue(filename.endswith(self.engine.language_patterns[language]['extensions'][0]))
    ...
    def test_dependency_suggestion(self):
        ...
        test_cases = [
            ("create authentication with password hashing", "python", ["hashlib", "secrets"]),
...
class TestCodeWriterIntegration(unittest.TestCase):
    ...
    def test_different_task_types(self):
        ...
        for task in test_tasks:
            ...
            self.assertGreater(len(result["files"]), 0, f"No files generated for: {task}")
...
class TestCodeQuality(unittest.TestCase):
    ...
    def test_usage_examples(self):
        ...
        self.assertIn("Example", code.split("def main()")[1] if "def main()" in code else code)
