...
class MemoryParser:
    ...
    def _build_metadata(self, content: str, sections: List[MemorySection], tasks: List[Task]) -> Dict[str, Any]:
        ...
        return {
            ...
            'sections_with_tasks': len([s for s in sections if any(t.section == s.name for t in tasks)]),
