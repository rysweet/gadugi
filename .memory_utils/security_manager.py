...
class SecurityResult:
    ...
    def __init__(self, is_safe: bool, issues: List[str], sanitized_content: Optional[str] = None):
...
class SecurityManager:
    ...
    def _check_patterns(self, content: str, patterns: List[str], 
    ...
    def _sanitize_content(self, content: str, issues: List[str]) -> str:
        ...
        for pattern in self.SECRET_PATTERNS:
            sanitized = re.sub(pattern, "[SECRET_REMOVED]", sanitized, flags=re.IGNORECASE)
    ...
    def scan_for_poisoning(self, new_content: str, previous_content: str, 
                          threshold: float = 0.7) -> Tuple[bool, Optional[str]]:
        """
        ...
        old_xpia = set(self._check_patterns(previous_content, self.XPIA_PATTERNS, "XPIA"))
