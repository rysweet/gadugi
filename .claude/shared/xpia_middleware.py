...
class XPIAMiddleware:
    ...
    def validate_user_input(self, content: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
    ...
    def validate_agent_communication(self, content: str, source_agent: str = 'unknown',
                                   target_agent: str = 'unknown') -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Log security decision
            self._log_security_decision(result, 'agent_communication', f"{source_agent}->{target_agent}")
    ...
    def validate_file_content(self, content: str, filename: str = 'unknown',
    ...
    def _process_validation_result(self, result: ValidationResult, context_type: str) -> Dict[str, Any]:
        ...
        if should_block:
            ...
            response['reason'] = f"Allowed with sanitization - {len(result.threats_detected)} threats mitigated"
        else:
    ...
    def _log_security_decision(self, result: ValidationResult, context_type: str, context_detail: str):
...
def get_xpia_middleware(security_mode: SecurityMode = SecurityMode.BALANCED) -> XPIAMiddleware:
...
def xpia_validate_user_input(content: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
...
def xpia_validate_agent_communication(content: str, source_agent: str = 'unknown',
                                    target_agent: str = 'unknown') -> Dict[str, Any]:
...
def xpia_validate_file_content(content: str, filename: str = 'unknown',
                             file_type: str = 'unknown') -> Dict[str, Any]:
