...
class TestTaskAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.analyzer = TaskAnalyzer(
            prompts_dir=str(self.prompts_dir), project_root=str(self.project_root)
        )
    ...
    def test_estimate_duration(self):
        ...
        duration = self.analyzer._estimate_duration(
            TaskComplexity.HIGH, ["f1.py", "f2.py", "f3.py"]
        )
...
"""
    ...
    def test_detect_conflicts(self):
        ...
        task2 = TaskInfo(
            id="task2",
            name="Task 2",
            prompt_file="task2.md",
            task_type=TaskType.BUG_FIX,
            complexity=TaskComplexity.LOW,
            target_files=["file2.py", "file3.py"],
            test_files=[],
...
class TestTaskAnalyzerIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.analyzer = TaskAnalyzer(
            prompts_dir=str(self.prompts_dir), project_root=str(self.temp_dir)
        )
