...
class RealtimeAssignment:
    ...
    def __init__(
        ...
        self.stop_processing = threading.Event()  # type: ignore[misc]
    ...
    def start_processing(self):
        ...
        if self.processing_thread is None or not self.processing_thread.is_alive():
            self.stop_processing.clear()  # type: ignore[attr-defined]
    ...
    def stop_processing(self):
        ...
        self.stop_processing.set()  # type: ignore[attr-defined]
    ...
    def _process_assignment_queue(self):
        ...
        try:
            while not self.stop_processing.is_set():  # type: ignore[attr-defined]
                try:
                    ...
                    if not self.assignment_queue.empty():
                        ...
                        self.stop_processing.wait(0.1)  # type: ignore[attr-defined]
