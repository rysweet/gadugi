...
from ...shared.interfaces import AgentMetrics, TaskResult, PerformanceMetrics
...
class MetricsCollector:
    ...
    def collect_metrics_batch(self, 
                            metrics: List[Tuple[str, str, Union[float, int, str, bool], Dict[str, Any]]]) -> int:
        """
    ...
    def aggregate_metric(self,
                        ...
                        start_time: Optional[datetime] = None,
                        end_time: Optional[datetime] = None,
                        aggregation_method: Optional[str] = None) -> Optional[AggregatedMetric]:
        """
    ...
    def get_agent_metrics_summary(self, 
                                agent_id: str,
    ...
    def register_collection_hook(self, 
                                source: MetricSource,
                                hook_function: Callable[[MetricDataPoint], None]) -> None:
        """
    ...
    def _validate_metric_value(self, 
                             ...
                             value: Union[float, int, str, bool]) -> bool:
