...
from ..phase1.performance_analytics import (
    AgentPerformanceAnalyzer, AgentPerformanceData, TeamPerformanceData,
    PerformanceCategory, AnalysisError, ReportGenerationError
)
from ...shared.interfaces import TaskResult, AgentConfig
...
class TestAgentPerformanceAnalyzer(unittest.TestCase):
    ...
    def test_analyze_agent_performance_success(self):
        ...
        self.mock_task_metrics.get_agent_execution_times.return_value = [120.0, 150.0, 200.0, 100.0]
    ...
    def test_generate_performance_report(self):
        ...
        with patch.object(self.analyzer, 'analyze_agent_performance', return_value=mock_performance_data):
            # Generate report
            report = self.analyzer.generate_performance_report(self.agent_id, self.time_period, detailed=True)
    ...
    def test_caching_behavior(self):
        ...
        result1 = self.analyzer.analyze_agent_performance(self.agent_id, self.time_period)
        
        # Second call - should use cache
        result2 = self.analyzer.analyze_agent_performance(self.agent_id, self.time_period)
    ...
    def test_trend_analysis(self):
        ...
        # Mock trend data
        with patch.object(self.analyzer, '_get_period_performance_score', side_effect=[0.6, 0.7, 0.8, 0.75, 0.85]):
