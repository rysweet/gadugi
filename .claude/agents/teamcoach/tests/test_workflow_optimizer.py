...
from ..phase3.workflow_optimizer import (
    WorkflowOptimizer, WorkflowAnalysis, WorkflowMetrics,
    Bottleneck, WorkflowOptimization, BottleneckType, OptimizationType
)
...
class TestWorkflowOptimizer(unittest.TestCase):
    ...
    def test_detect_resource_bottlenecks(self):
        ...
        gpu_bottlenecks = [
            b for b in resource_bottlenecks 
            if 'gpu_1' in b.evidence.get('resource', '')
        ]
    ...
    def test_detect_skill_bottlenecks(self):
        ...
        skill_bottlenecks = [
            b for b in analysis.bottlenecks 
            if b.type == BottleneckType.SKILL_GAP
        ]
        ...
        dl_bottlenecks = [
            b for b in skill_bottlenecks 
            if 'deep_learning' in b.description
        ]
    ...
    def test_detect_dependency_bottlenecks(self):
        ...
        dep_bottlenecks = [
            b for b in analysis.bottlenecks 
            if b.type == BottleneckType.DEPENDENCY_CHAIN
        ]
    ...
    def test_detect_process_bottlenecks(self):
        ...
        rework_bottlenecks = [
            b for b in process_bottlenecks 
            if 'rework' in b.description.lower()
        ]
    ...
    def test_generate_resource_optimization(self):
        ...
        resource_opts = [
            o for o in analysis.optimizations 
            ...
            for i in range(len(analysis.optimizations) - 1):
                ...
                if opt1.priority == opt2.priority:
                    self.assertGreaterEqual(
                        opt1.expected_improvement,
                        opt2.expected_improvement
                    )
    ...
    def test_workflow_pattern_learning(self):
        ...
        analysis2 = self.optimizer.analyze_workflow(
            self.workflow_data, self.agent_states, self.task_history
        )
