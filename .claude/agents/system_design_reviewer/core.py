...
try:
    ...
    from ..shared.error_handling import ErrorHandler, ErrorCategory, ErrorSeverity
    from ..shared.task_tracking import TaskTracker
except ImportError:
    # Fallback for development/testing
    print("Warning: Shared modules not available, using fallback implementations")
    from .fallbacks import GitHubOperations, StateManager, ErrorHandler, TaskTracker
