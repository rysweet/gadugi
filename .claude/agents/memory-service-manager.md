...
│   ├── Requires: neo4j-service-manager
│   └── Fallback: SQLite
...
def check_neo4j_memory_backend() -> Dict[str, Any]:
    ...
    try:
        # Test Neo4j connection via neo4j-service-manager
...
./memory-service-manager.md start

# Force Neo4j reconnection
./memory-service-manager.md restart

# Test all layers
./memory-service-manager.md test
```
