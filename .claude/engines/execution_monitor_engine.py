...
class ExecutionMonitorEngine:
    ...
    def _build_system_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "monitoring_uptime": (datetime.now() - datetime.now()).total_seconds()
    ...
    def _check_process_alerts(self, process: MonitoredProcess) -> None:
        ...
        if usage.cpu_usage > thresholds.cpu_threshold:
            alert = Alert(
                ...
                severity="critical"
                if usage.cpu_usage > thresholds.cpu_threshold * 1.2
                else "warning",
        ...
        if usage.memory_usage > thresholds.memory_threshold:
            alert = Alert(
                type=AlertType.RESOURCE,
                severity="critical"
                if usage.memory_usage > thresholds.memory_threshold * 1.2
                else "warning",
    ...
    def _cleanup_completed_processes(self) -> None:
        ...
        processes_to_cleanup = [
            process_id
            for process_id, process in self.monitored_processes.items()
            if (
                process.state
                in [
                ...
                and process.end_time
                and process.end_time < cleanup_threshold
            )
        ]
    ...
    def _handle_monitor_request(self, request_data: dict[str, Any]) -> dict[str, Any]:
        ...
        if not process_id:
            return {
                "success": False,
                "error": "process_id required for monitor operation",
            }
    ...
    try:
        ...
        test_request = {
            ...
            "parameters": {
                ...
                "alert_thresholds": {"cpu_threshold": 50.0, "memory_threshold": 128.0},
            },
        }
