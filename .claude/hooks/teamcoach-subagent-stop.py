...
""".strip()
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(f"⚠️ TeamCoach agent analysis failed for {agent_name}: {result.stderr}")
            return False
...
def main():
    ...
    try:
        ...
        result = {
            ...
            "message": f"TeamCoach agent analysis completed" if success else "TeamCoach agent analysis encountered issues",
