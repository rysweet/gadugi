...
from workflow_engine import (
    WorkflowEngine, WorkflowPhase, WorkflowState, PhaseResult,
    execute_workflow
)
...
class TestWorkflowPhases:
    ...
    def test_workflow_phases_exist(self):
        ...
        expected_phases = [
            'INIT', 'PROMPT_VALIDATION', 'BRANCH_CREATION', 'PROMPT_WRITER',
            'ISSUE_MANAGEMENT', 'DEVELOPMENT_PLANNING', 'IMPLEMENTATION',
            'COMMIT_CHANGES', 'PUSH_REMOTE', 'PR_CREATION', 'CODE_REVIEW',
            'REVIEW_RESPONSE', 'FINALIZATION'
        ]
