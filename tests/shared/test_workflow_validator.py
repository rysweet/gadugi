...
from workflow_validator import (
    WorkflowValidator, ValidationLevel, ValidationCategory, ValidationRule,
    ValidationResult, ValidationReport, validate_prompt, validate_workflow
)
...
""")
    ...
    def test_validation_report_creation(self):
        ...
        results = [
            ValidationResult("rule1", ValidationCategory.PROMPT_FORMAT, True, ValidationLevel.STANDARD, "Pass"),
            ValidationResult("rule2", ValidationCategory.GIT_STATE, False, ValidationLevel.STANDARD, "Fail")
        ]
    ...
    def test_validate_branch_exists_success(self, mock_subprocess):
        ...
        mock_subprocess.side_effect = [
            ...
            Mock(returncode=0, stdout="feature/test-validation\n", stderr="")  # git branch --show-current
        ]
    ...
    def test_validate_branch_exists_wrong_branch(self, mock_subprocess):
        ...
        mock_subprocess.side_effect = [
            Mock(returncode=0, stdout="", stderr=""),  # git show-ref (branch exists)
            Mock(returncode=0, stdout="main\n", stderr="")  # git branch --show-current (wrong branch)
        ]
    ...
    def test_generate_report_all_passed(self):
        ...
        results = [
            ValidationResult("rule1", ValidationCategory.PROMPT_FORMAT, True, ValidationLevel.STANDARD, "Pass 1"),
            ValidationResult("rule2", ValidationCategory.GIT_STATE, True, ValidationLevel.STANDARD, "Pass 2")
        ]
    ...
    def test_generate_report_with_failures(self):
        ...
        results = [
            ValidationResult("rule1", ValidationCategory.PROMPT_FORMAT, True, ValidationLevel.STANDARD, "Pass"),
            ValidationResult("rule2", ValidationCategory.GIT_STATE, False, ValidationLevel.STANDARD, "Fail warning"),
            ValidationResult("rule3", ValidationCategory.GITHUB_INTEGRATION, False, ValidationLevel.STRICT, "Fail error")
        ]
    ...
    def test_generate_report_with_suggestions(self):
        ...
        results = [
            ValidationResult(
                "rule1", ValidationCategory.PROMPT_FORMAT, False, ValidationLevel.STANDARD, 
                "Fail", suggestions=["Fix this", "Do that"]
            ),
            ValidationResult(
                "rule2", ValidationCategory.GIT_STATE, False, ValidationLevel.STANDARD,
                "Fail", suggestions=["Fix this", "Another fix"]  # Duplicate suggestion
            )
        ]
