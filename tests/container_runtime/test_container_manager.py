...
from container_runtime.container_manager import (
    ContainerManager, ContainerConfig, ContainerResult, ContainerStatus
)
...
def test_create_container_failure(container_manager, sample_config):
    ...
    container_manager.client.containers.create.side_effect = docker.errors.APIError("Creation failed")
