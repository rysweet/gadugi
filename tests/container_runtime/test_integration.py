...
class TestContainerExecutionEngine:
    ...
    def test_python_code_execution_mock(self, temp_dir):
        ...
        with patch('docker.from_env') as mock_docker:
            ...
            with patch('container_runtime.container_manager.ContainerManager.execute_container') as mock_execute:
                from container_runtime.container_manager import ContainerResult, ContainerStatus
                ...
                mock_result = ContainerResult(
                    ...
                    stderr="",
                    execution_time=1.5,
                    resource_usage={'cpu_percent': 10.0, 'memory_usage_bytes': 50000000},
                    status=ContainerStatus.STOPPED
                )
                mock_execute.return_value = mock_result
                
                # Mock image manager
                with patch('container_runtime.image_manager.ImageManager.get_or_create_runtime_image') as mock_image:
