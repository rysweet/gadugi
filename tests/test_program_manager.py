...
with multiple lines"""
    ...
    def test_lifecycle_stage_detection(self):
        ...
        with patch('builtins.print') as mock_print:
            stage = self.pm.get_current_lifecycle_stage(issue)
            mock_print.assert_called_with("Warning: Issue #1 has multiple lifecycle labels: ['idea', 'draft']")
    ...
    def test_triage_unlabeled_issues(self, mock_run):
        ...
        self.pm.memory.record_agent_memory.assert_called_with(
            "issue_triage",
            "Triaged 2 issues: 0 ideas, 1 drafts, 1 bugs"
        )
    ...
    def test_update_project_priorities(self, mock_run):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('os.path.dirname') as mock_dirname:
                ...
                self.assertTrue(os.path.exists(priority_file))
    ...
    def test_run_full_maintenance(self):
        ...
        with patch.object(self.pm, 'run_full_triage') as mock_triage, \
