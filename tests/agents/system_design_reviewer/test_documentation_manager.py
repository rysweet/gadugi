...
class TestDocumentationManager:
    ...
    def test_identify_sections_to_update_component_changes(self, sample_changes):
        ...
        component_changes = [c for c in sample_changes if c.element.element_type == ElementType.CLASS]
...
"""
    ...
    def test_generate_component_architecture_new_components(self, sample_changes):
        ...
        new_components = [c for c in sample_changes 
...
"""
    ...
    def test_update_architecture_doc_existing_file(self, sample_architecture_doc, sample_changes, sample_pr_info):
