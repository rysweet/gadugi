...
class TestSystemDesignReviewer:
    ...
    def test_get_pr_info_success(self, mock_subprocess, mock_pr_info):
        ...
        with patch.object(reviewer, '_get_changed_files', return_value=mock_pr_info['changed_files']):
    ...
    def test_generate_review_comments_high_impact(self, sample_architectural_changes):
        ...
        comments = reviewer._generate_review_comments(sample_architectural_changes, ImpactLevel.HIGH)
