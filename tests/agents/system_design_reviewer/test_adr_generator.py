...
class TestADRGenerator:
    ...
    def test_generate_context(self, sample_changes_requiring_adr, sample_pr_info):
        ...
        context = generator._generate_context("security_change", sample_changes_requiring_adr, sample_pr_info)
    ...
    def test_generate_alternatives(self, sample_changes_requiring_adr):
        ...
        alternatives = generator._generate_alternatives("security_change", sample_changes_requiring_adr)
    ...
    def test_create_adr_data(self, sample_changes_requiring_adr, sample_pr_info):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            adr_data = generator._create_adr_data("security_change", sample_changes_requiring_adr, sample_pr_info)
    ...
    def test_slugify(self):
        ...
        assert generator._slugify("Complex: Title with Special! Characters?") == "complex-title-with-special-characters"
        assert generator._slugify("Multi---Hyphen--Title") == "multi-hyphen-title"
        assert generator._slugify("  Leading and Trailing Spaces  ") == "leading-and-trailing-spaces"
    ...
    def test_generate_adrs_success(self, sample_changes_requiring_adr, sample_pr_info):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for adr_path in adrs:
                ...
                assert "Security architecture modification" in content or "security" in content.lower()
