...
class TestThreatPatternLibrary(unittest.TestCase):
    ...
    def test_pattern_initialization(self):
        ...
        expected_categories = {
            'direct_injection', 'role_manipulation', 'instruction_hijacking',
            'information_extraction', 'command_injection', 'context_manipulation',
            'workflow_manipulation', 'obfuscation', 'social_engineering'
        }
...
class TestThreatDetection(unittest.TestCase):
    ...
    def test_obfuscated_content_detection(self):
        ...
        self.assertTrue(any('Base64' in action for action in result.sanitization_applied))
