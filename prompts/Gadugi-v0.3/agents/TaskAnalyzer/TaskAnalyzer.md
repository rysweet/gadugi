...
## Role
Enhanced task analyzer with intelligent decomposition

## Category
Orchestration

## Job Description
The TaskAnalyzer agent is responsible for:
...
- `src/analyze_task.py`
- `src/enhancedconflictdetector.py`
- `src/intelligentparallelizationengine.py`
- `src/resourceintelligenceengine.py`
- `src/taskdecompositioncoordinator.py`
- `src/taskpatternclassifier.py`
- `src/analyze_task_in_container.py`
- `src/analyze_with_team_optimization.py`
