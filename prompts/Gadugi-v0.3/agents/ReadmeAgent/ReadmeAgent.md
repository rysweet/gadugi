...
## Role
Manages and maintains README.md files

## Category
Documentation

## Job Description
The ReadmeAgent agent is responsible for:
...
- `src/readmeanalyzer.py`
- `src/projectanalyzer.py`
- `src/contentvalidator.py`
- `src/readmeenhancer.py`
- `src/readmetester.py`
- `src/handle_new_agent.py`
- `src/handle_version_bump.py`
