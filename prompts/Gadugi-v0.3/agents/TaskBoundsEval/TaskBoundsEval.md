...
# TaskBoundsEval Agent

## Role
Evaluates whether tasks are well understood and bounded

## Category
Planning

## Job Description
The TaskBoundsEval agent is responsible for:
...
- `src/assess_well_bounded.py`
- `src/requires_decomposition.py`
- `src/requires_research.py`
- `src/analyze_complexity.py`
- `src/assess_risks.py`
- `src/taskboundsevaluator.py`
- `src/taskcomplexitypredictor.py`
