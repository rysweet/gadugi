...
- `src/assess_well_bounded.py` - assess_well_bounded implementation
- `src/requires_decomposition.py` - requires_decomposition implementation
- `src/requires_research.py` - requires_research implementation
- `src/analyze_complexity.py` - analyze_complexity implementation
- `src/assess_risks.py` - assess_risks implementation
