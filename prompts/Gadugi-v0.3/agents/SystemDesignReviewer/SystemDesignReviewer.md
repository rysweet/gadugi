...
# SystemDesignReviewer Agent

## Role
Reviews architectural decisions and system design

## Category
Architecture

## Job Description
The SystemDesignReviewer agent is responsible for:
