...
- `src/functional_decomposition.py` - functional_decomposition implementation
- `src/layer_decomposition.py` - layer_decomposition implementation
- `src/workflow_decomposition.py` - workflow_decomposition implementation
- `src/risk_decomposition.py` - risk_decomposition implementation
- `src/code_5.py` - code_5 implementation
- `src/code_6.py` - code_6 implementation
- `src/code_7.py` - code_7 implementation
- `src/code_8.py` - code_8 implementation
- `src/analyze_task_for_decomposition.py` - analyze_task_for_decomposition implementation
- `src/select_decomposition_strategy.py` - select_decomposition_strategy implementation
- `src/generate_subtasks.py` - generate_subtasks implementation
- `src/model_dependencies.py` - model_dependencies implementation
- `src/optimize_subtask_structure.py` - optimize_subtask_structure implementation
- `src/decompose_by_pattern.py` - decompose_by_pattern implementation
- `src/context_aware_decomposition.py` - context_aware_decomposition implementation
