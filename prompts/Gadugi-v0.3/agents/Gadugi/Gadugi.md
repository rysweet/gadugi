...
## Role
Main Gadugi agent for system management

## Category
Infrastructure

## Job Description
The Gadugi agent is responsible for:
...
- `src/install_gadugi_service.py`
- `src/setup_github_webhook.py`
- `src/manage_configuration.py`
- `src/manage_service.py`
- `src/validate_installation.py`
