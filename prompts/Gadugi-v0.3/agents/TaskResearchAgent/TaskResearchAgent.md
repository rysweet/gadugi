...
- `src/technology_research.py` - technology_research implementation
- `src/solution_research.py` - solution_research implementation
- `src/feasibility_research.py` - feasibility_research implementation
- `src/comparative_research.py` - comparative_research implementation
- `src/create_research_plan.py` - create_research_plan implementation
- `src/gather_information.py` - gather_information implementation
- `src/analyze_research_findings.py` - analyze_research_findings implementation
- `src/validate_research_findings.py` - validate_research_findings implementation
- `src/execute.py` - execute implementation
- `src/execute.py` - execute implementation
- `src/execute.py` - execute implementation
- `src/execute.py` - execute implementation
- `src/research_driven_decomposition.py` - research_driven_decomposition implementation
