...
class DependencyResolver:
    ...
    def analyze_impact(self, recipe_name: str, all_recipes: Dict[str, Recipe]) -> Dict[str, Set[str]]:
    ...
    def get_execution_plan(self, target: str, all_recipes: Dict[str, Recipe]) -> List[Tuple[int, List[str]]]:
