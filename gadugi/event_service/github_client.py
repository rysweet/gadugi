...
class GitHubClient:
    ...
    async def get_events_since(self, since: datetime, owner: str = None, repo: str = None) -> List[Dict[str, Any]]:
    ...
    async def get_issues(self, owner: str, repo: str, state: str = "open", since: Optional[datetime] = None) -> List[Dict[str, Any]]:
    ...
    async def create_webhook(
        ...
        try:
            ...
            return await self._request("POST", f"/repos/{owner}/{repo}/hooks", json=webhook_config)
        except Exception as e:
